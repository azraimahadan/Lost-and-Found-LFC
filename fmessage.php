...
if($result){
    ...
    {
        if($row[imageUp] != null)
            echo "<tr><td colspan=2><img src='fuploads/$row[imageUp]' class='articleimg'></td></tr>";
...
?>
    ...
    <a href="fboard_read.php?num=<? echo $post_num ?>"><button class="btn5" >Back to article</button></a>
</div>
