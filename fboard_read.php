...
<script type="text/javascript">
    function ShowHideDiv(btnReply) {
        ...
        dvReply.style.display = btnReply.value == "?‹µê¸?" ? "block" : "none";
    }
</script>
<style>
a{
...
?>
                <form class="btnform" name="b2b" method="post" action="fboard_main.php">
                <input class="btn5" type="submit" value="Back to board">
                </form>
                <form class="btnform" action="fmessage.php">
            ...
            <input class="btn5" type="submit" value="Message">
                </form>
...
?>
    ...
    <form class="btnform" name="delete" method="post" action="ftext_delete.php?num=<? echo $num ?>">
