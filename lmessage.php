...
echo "<div class='time-right'>$row[id_one] | $row[dtime]</div><br><br>";
echo  "<p>$row[message]</p><br>";
echo "</div>";
}
else{
echo "<div class='container1 darker'>";
echo "<div class='time-left'>$row[id_two] | $row[dtime]</div><br><br>";
echo  "<p>$row[message]</p><br>";
echo "</div>";
}
}
...
?>
    ...
    <form action="message_insert.php"><td colspan="1"><input id = "btnn" size="30" type="text" name="message"></td>
            <td><input class="textbox-msg" type="hidden" name="post_num" value= "<?php echo $post_num ?>"></td>
